            ...
            function(e, t) {
                !(function() {
                    ...
                    ;(e.prototype.needsClick = function(e) {
                        ...
                        (e.prototype.getTargetElementFromEventTarget = function(
                            e,
                        ) {
                        ...
                        (e.prototype.onTouchStart = function(e) {
                            ...
                            if (
                                ((t = this.getTargetElementFromEventTarget(
                                    e.target,
                                )),
                                (n = e.targetTouches[0]),
                                i)
                            ...
                            return (
                                ...
                                e.timeStamp - this.lastClickTime <
                                    this.tapDelay && e.preventDefault(),
                                !0
                            )
                        }),
                        ...
                        (e.prototype.onTouchMove = function(e) {
                            return this.trackingClick
                                ? ((this.targetElement !==
                                      this.getTargetElementFromEventTarget(
                                          e.target,
                                      ) ||
                        ...
                        (e.prototype.onTouchEnd = function(e) {
                            ...
                            if (
                                e.timeStamp - this.trackingClickStart >
                                this.tapTimeout
                            )
                                return !0
                            if (
                        ...
                        (e.notNeeded = function(e) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        -1 !==
                                        t.content.indexOf('user-scalable=no')
                                    )
                                        return !0
                                    if (
                                        n > 31 &&

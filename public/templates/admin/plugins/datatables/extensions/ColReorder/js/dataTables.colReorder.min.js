...
;(function(o, r, s) {
    ...
    o = function(d) {
        ...
        f.prototype = {
            fnReset: function() {
                for (
                    var a = [], b = 0, e = this.s.dt.aoColumns.length;
                    b < e;
                    b++
                )
            ...
            _fnOrderColumns: function(a) {
                if (a.length != this.s.dt.aoColumns.length)
                    ...
                    for (var b = 0, e = a.length; b < e; b++) {
                        var h = d.inArray(b, a)
                        b != h &&
                            (l(a, h, b), this.s.dt.oInstance.fnColReorder(h, b))
                    }
            ...
            _fnStateSave: function(a) {
                ...
                if (a.aaSorting) {
                    for (b = 0; b < a.aaSorting.length; b++)
                        a.aaSorting[b][0] =
                            c[a.aaSorting[b][0]]._ColReorder_iOrigCol
                ...
                for (var b = 0, e = 0, f = a.length; e < f; e++)
                    e != this.s.mouse.fromIndex && b++,
                        a[e].bVisible &&
                            this.s.aoTargets.push({
                                x:
                                    d(a[e].nTh).offset().left +
                                    d(a[e].nTh).outerWidth(),
                                to: b,
                            })
                0 !== this.s.fixedRight &&
            ...
            _fnCreateDragNode: function() {
                ...
                this.dom.drag = d(c.cloneNode(!1))
                    ...
                    .append(
                        d(f.cloneNode(!1)).append(
                            d(e.cloneNode(!1)).append(g[0]),
                        ),
                    )
                    .css({
                        position: 'absolute',
            ...
            _fnDestroy: function() {
                ...
                for (b = this.s.dt.aoDrawCallback.length; a < b; a++)
                    if (
                        'ColReorder_Pre' === this.s.dt.aoDrawCallback[a].sName
                    ) {
            ...
            ? d.fn.dataTableExt.aoFeatures.push({
                  fnInit: function(a) {
                      ...
                      a._colReorder
                          ...
                          : ((b = a.oInit),
                            new f(a, b.colReorder || b.oColReorder || {}))
                      return null
                  },
                  cFeature: 'R',
                  sFeature: 'ColReorder',

        ...
        KeyTable = function(oInit) {
            ...
            function _fnSetFocus(nTarget, bAutoScroll) {
                ...
                if (
                    ...
                    if (
                        nTarget.offsetTop + iHeight >
                        iViewportHeight + iScrollTop
                    ) {
                    ...
                    if (
                        nTarget.offsetLeft + iWidth >
                        iViewportWidth + iScrollLeft
                    ) {
            ...
            function _fnCellFromCoords(x, y) {
                if (_oDatatable) {
                    if (
                        typeof _oDatatable.aoData[_oDatatable.aiDisplay[y]] !=
                        'undefined'
                    ) {
            ...
            function _fnFindDtCell(nTarget) {
                for (
                    var i = 0, iLen = _oDatatable.aiDisplay.length;
                    i < iLen;
                    i++
                ) {
            ...
            function _fnInit(table, datatable, oInit, that) {
                ...
                if (_bForm) {
                    ...
                    nDiv.style.height =
                        '1px' /* Opera requires a little something */
                    ...
                    oInit.table.parentNode.insertBefore(
                        nDiv,
                        oInit.table.nextSibling,
                    )

...
;(function(window, document, undefined) {
	 ...
	 */
                ...
                fnSelectAll: function(filtered) {
                    this._fnRowSelect(
                        filtered ? this.s.dt.aiDisplay : this.s.dt.aoData,
                    )
                },
                ...
                fnGetTitle: function(oConfig) {
                    var sTitle = ''
                    if (
                        typeof oConfig.sTitle != 'undefined' &&
                        oConfig.sTitle !== ''
                    ) {
                ...
                _fnConstruct: function(oOpts) {
                    ...
                    /* Container element */
                    this.dom.container = document.createElement(
                ...
                _fnButtonDefinations: function(buttonSet, wrapper) {
                    ...
                    for (var i = 0, iLen = buttonSet.length; i < iLen; i++) {
                        if (typeof buttonSet[i] == 'string') {
                            if (
                                typeof TableTools.BUTTONS[buttonSet[i]] ==
                                'undefined'
                            ) {
                                alert(
                            ...
                            buttonDef = $.extend(
                                {},
                                TableTools.BUTTONS[buttonSet[i]],
                                true,
                            )
                        } else {
                            if (
                                typeof TableTools.BUTTONS[
                ...
                _fnCollectionShow: function(nButton, oConfig) {
                    ...
                    nBackground.style.height =
                        (iWinHeight > iDocHeight ? iWinHeight : iDocHeight) +
                        'px'
                ...
                _fnHtmlDecode: function(sData) {
                    ...
                    return sData.replace(/&([^\s]*?);/g, function(
                        match,
                        match2,
                    ) {
                        if (match.substr(1, 1) === '#') {
                ...
                _fnPrintScrollStart: function() {
                    ...
                    if (oSetDT.oScroll.sX !== '') {
                        oSetDT.nTable.style.width =
                            $(oSetDT.nTable).outerWidth() + 'px'
            ...
            TableTools.fnGetMasters = function() {
                var a = []
                for (
                    var i = 0, iLen = TableTools._aInstances.length;
                    i < iLen;
                    i++
                ) {
            ...
            if (
                ...
                $.fn.dataTableExt.aoFeatures.push({
                    fnInit: function(oDTSettings) {
                        ...
                        return new TableTools(oDTSettings.oInstance, opts).dom
                            .container
                    },
                    cFeature: 'T',
                    sFeature: 'TableTools',

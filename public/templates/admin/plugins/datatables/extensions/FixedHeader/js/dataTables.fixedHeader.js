    ...
    var factory = function($, DataTable) {
        ...
        FixedHeader.prototype = {
            ...
            _fnMeasure: function() {
                ...
                m.iTableRight =
                    FixedHeader.oDoc.iWidth - m.iTableLeft - m.iTableWidth
                m.iTableBottom =
            ...
            _fnCloneTRight: function(oCache) {
                ...
                $(
                    'thead tr th:lt(' + (iCols - oCache.iCells) + ')',
                    nTable,
                ).remove()
                $(
                    'tfoot tr th:lt(' + (iCols - oCache.iCells) + ')',
                    nTable,
                ).remove()
        ...
        $(window).scroll(function() {
            ...
            for (
                var i = 0, iLen = FixedHeader.afnScroll.length;
                i < iLen;
                i++
            ) {

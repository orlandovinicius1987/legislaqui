...
;(function(factory) {
    ...
    fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
        ...
        var fcOptions =
            langOptionHash[langCode] || (langOptionHash[langCode] = {})
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    function getFormatStringChunks(formatStr) {
        ...
        return (formatStringChunkCache[formatStr] = chunkFormatString(
            formatStr,
        ))
    }
    ...
    var Popover = Class.extend({
        ...
        render: function() {
            ...
            if (options.autoHide) {
                $(document).on(
                    'mousedown',
                    (this.documentMousedownProxy = $.proxy(
                        this,
                        'documentMousedown',
                    )),
                )
        ...
        startListening: function(ev) {
            ...
            if (!this.isListening) {
                ...
                $(document)
                    ...
                    .on(
                        'mouseup',
                        (this.mouseupProxy = $.proxy(this, 'mouseup')),
                    )
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        dragScroll: function(ev) {
            ...
            if (bounds) {
                ...
                topCloseness =
                    (sensitivity - (ev.pageY - bounds.top)) / sensitivity
                bottomCloseness =
                    (sensitivity - (bounds.bottom - ev.pageY)) / sensitivity
                leftCloseness =
                    (sensitivity - (ev.pageX - bounds.left)) / sensitivity
                rightCloseness =
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    var RowRenderer = Class.extend({
        ...
        getHtmlRenderer: function(rendererName, rowType) {
            ...
            if (rowType) {
                specificName =
                    rowType + capitaliseFirstLetter(rendererName) + 'Html'
            }
            ...
            var dragListener = new DragListener(this.coordMap, {
                ...
                cellOver: function(cell, isOrig) {
                    ...
                    if (origCell) {
                        ...
                        if (isSelectable) {
                            selectionRange = _this.computeSelection(
                                origCell,
                                cell,
                            )
                            if (selectionRange) {
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        computeCellRange: function(cell) {
            ...
            var index =
                cell.row * colCnt +
                (this.isRTL ? colCnt - cell.col - 1 : cell.col)
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        processOptions: function() {
            ...
            this.axisFormat =
                view.opt('axisFormat') || view.opt('smallTimeFormat')
        },
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        computeRowCoords: function() {
            ...
            item.bottom =
                item.top + this.computeTimeTop(this.computeSnapTime(i))
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	-----------------------------------------------------------------------------*/
        ...
        function updateTodayButton() {
            var now = t.getNow()
            if (
                now.isWithin(currentView.intervalStart, currentView.intervalEnd)
            ) {
                    ...
                    $.each(this.split(','), function(j, buttonName) {
                        ...
                        if (buttonName == 'title') {
                            ...
                            if (calendar[buttonName]) {
                                ...
                                viewText = calendar.getViewButtonText(
                                    buttonName,
                                )
                            }
                            if (buttonClick) {
                                // smartProperty allows different text per view button (ex: "Agenda Week" vs "Basic Week")
                                themeIcon = smartProperty(
                                    options.themeButtonIcons,
                                    buttonName,
                                )
                                normalIcon = smartProperty(
                                    options.buttonIcons,
                                    buttonName,
                                )
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        setHeight: function(totalHeight, isAuto) {
            ...
            if (
                !isAuto &&
                setPotentialScroller(this.scrollerEl, scrollerHeight)
            ) {
                // using scrollbars?

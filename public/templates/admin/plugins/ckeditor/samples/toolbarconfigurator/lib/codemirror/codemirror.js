;(function(q) {
    ...
    function Re(a) {
        return a.findMarks(r(a.first, 0), a.clipPos(r(a.lastLine())), function(
            a,
        ) {
            return a.parent
        })
    ...
    function cf(a, b, c, d) {
        var e = b['spans_' + a.id],
            f = 0
        a.iter(Math.max(a.first, c), Math.min(a.first + a.size, d), function(
            c,
        ) {
            c.markedSpans &&
    ...
    Uc.prototype = V(
        {
            init: function(a) {
                ...
                v(a, 'paste', function(a) {
                    var b =
                        a.clipboardData && a.clipboardData.getData('text/plain')
                    b &&
                        (a.preventDefault(),
        ...
        if (!this.explicitlyCleared) {
            ...
            for (var d = (c = null), e = 0; e < this.lines.length; ++e) {
                ...
                a && !this.collapsed
                    ? na(a, F(f), 'text')
                    : a &&
                      (null != g.to && (d = F(f)), null != g.from && (c = F(f)))
                for (

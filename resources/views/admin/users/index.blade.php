    ...
    <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right"><a href="/admin/users/create" class="btn btn-success" id="criarNovoUsuario"><span class="fas fa-plus" aria-hidden="true"></span> Criar Novo Usuário</a></div>
            </div><!-- /.box-header -->
            <div class="box-body">

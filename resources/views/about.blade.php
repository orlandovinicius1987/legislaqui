...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading text-center"><strong>IDEIAS LEGISLATIVAS – Instruções de funcionamento</strong></div>
        <div class="panel-body">
            <div class="termo">
                <p class="instrucao-topico">
                    Objetivo:
                </p>
                <p>
                ...
                <p>
                    a) Área temática da Ideia Legislativa: você deverá selecionar o tema a que se refere sua Ideia Legislativa. Somente é possível escolher uma opção. Se a ideia tem relação com várias áreas, indique a principal.
                </p>
                <p>
                    b) Ideia Central: neste campo, você deve expor, em poucas palavras, o que é essencial em sua ideia. Seja claro e conciso, pois esse campo identificará sua Ideia Legislativa na lista geral.
                </p>
                <p>
                    c) Identificação do Problema: neste campo, você apresenta, em poucas palavras, o problema que, em seu entendimento, seria solucionado ou atenuado com a implementação de sua Ideia Legislativa.
                </p>
                <p>
                    d) Exposição da Ideia: neste campo, você deverá expor sua ideia legislativa de maneira mais detalhada. Aproveite para apresentar seus argumentos e convencer os demais cidadãos a apoiá-la.
                </p>
                <p>
                    PASSO 3:
                </p>
                ...
                <p>
                    a) Ideia contraria cláusula pétrea da Constituição Federal;
                </p>
                <p>
                    b) Ideia escapa às competências legislativas do Congresso Nacional ou aos limites da iniciativa parlamentar;
                </p>
                <p>
                    c) Inadequação redacional insanável;
                </p>
                <p>
                    d) Ideia repetida.
                </p>

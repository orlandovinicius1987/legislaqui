...
{{--TESTE FLEX DO ZERO--}}
{{--
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark d-flex justify-content-between bd-highlight mb-3">
        <div class="p-2 col-sm-6 col-md-2">
        ...
        <div class="p-2"><a class="nav-link " href="/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Bootstrap');">Home</a>
        </div>

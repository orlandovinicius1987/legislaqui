        ...
        FixedHeader.prototype = {
            ...
            fnInitSettings: function(a, b) {
                if (
                    ...
                    b.alwaysCloneTop !== h &&
                        (a.oCloneOnDraw.top = b.alwaysCloneTop),
                    b.alwaysCloneBottom !== h &&
                        (a.oCloneOnDraw.bottom = b.alwaysCloneBottom),
                    b.alwaysCloneLeft !== h &&
                        (a.oCloneOnDraw.left = b.alwaysCloneLeft),
            ...
            _fnMeasure: function() {
                ...
                b.iTableRight =
                    FixedHeader.oDoc.iWidth - b.iTableLeft - b.iTableWidth
                b.iTableBottom =
            ...
            _fnCloneTfoot: function(a) {
                ...
                e('tfoot:eq(0)>tr th', b.nTable).each(function(a) {
                    e('tfoot:eq(0)>tr th:eq(' + a + ')', c).width(
                        e(this).width(),
                    )
                })
                e('tfoot:eq(0)>tr td', b.nTable).each(function(a) {
                    e('tfoot:eq(0)>tr td:eq(' + a + ')', c).width(
                        e(this).width(),
                    )
                })
            },

    ...
    var factory = function($, DataTable) {
        ...
        Scroller.prototype = /** @lends Scroller.prototype */ {
            ...
            fnPixelsToRow: function(pixels, intParse, virtual) {
                ...
                var row = virtual
                    ? this._domain('physicalToVirtual', pixels) /
                      this.s.heights.row
            ...
            _fnScroll: function() {
                ...
                if (
                    ...
                    if (
                        ...
                        this.s.topRowFloat = this.fnPixelsToRow(
                            iScrollTop,
                            false,
                        )
                    }
            ...
            _fnDrawCallback: function() {
                ...
                var tableTop =
                    iScrollTop -
                    (this.s.topRowFloat - displayStart) * heights.row
                if (displayStart === 0) {
                    tableTop = 0
                } else if (displayStart + displayLen >= displayEnd) {
        ...
        if ($.fn.dataTable.Api) {
            ...
            Api.register('scroller().rowToPixels()', function(
                ...
                if (ctx.length && ctx[0].oScroller) {
                    return ctx[0].oScroller.fnRowToPixels(
                        rowIdx,
                        intParse,
                        virtual,
                    )
            ...
            Api.register('scroller().pixelsToRow()', function(
                ...
                if (ctx.length && ctx[0].oScroller) {
                    return ctx[0].oScroller.fnPixelsToRow(
                        pixels,
                        intParse,
                        virtual,
                    )

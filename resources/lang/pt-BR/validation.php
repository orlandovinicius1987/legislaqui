...
return [
    ...
    */
    ...
    'digits_between' =>
        'O campo :attribute deverá conter entre :min a :max dígitos.',
    ...
    'required_without' =>
        'O campo :attribute é obrigatório quanto :values não está presente.',
    ...
    'unique' =>
        'O valor indicado para o campo :attribute já se encontra utilizado.',

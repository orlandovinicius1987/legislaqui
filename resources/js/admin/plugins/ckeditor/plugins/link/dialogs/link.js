        ...
        I = function(a, g) {
            ...
            if (g) {
                ...
                if (d)
                    ...
                    (d =
                        (d =
                            g.data('cke-pa-onclick') ||
                            g.getAttribute('onclick')) && d.match(G))
                ) {
                    b.target.type = 'popup'
            ...
            if (CKEDITOR.plugins.link.fakeAnchor) {
                ...
                c = 0
                for (e = f.count(); c < e; c++)
                    (h = CKEDITOR.plugins.link.tryRestoreFakeAnchor(
                        a,
                        f.getItem(c),
                    )) &&
                        d.push({
        ...
        onOk: function() {
            ...
            if (this._.selectedElement) {
                ...
                c.adv &&
                    ...
                    CKEDITOR.plugins.link.synAnchorSelector &&
                    d.addClass(
                        d.getChildCount() ? 'cke_anchor' : 'cke_anchor_empty',
                    )

...
;(function(n, k, q) {
    var p = function(m, p) {
        ...
        g.Client.prototype = {
            ...
            getHTML: function(a, b) {
                ...
                if (navigator.userAgent.match(/MSIE/))
                    var f = location.href.match(/^https/i)
                            ? 'https://'
                            : 'http://',
                        c =
                            c +
        ...
        TableTools.prototype = {
            ...
            _fnButtonDefinations: function(a, b) {
                for (var c, d = 0, f = a.length; d < f; d++) {
                    if ('string' == typeof a[d]) {
                        ...
                        if (
                            'undefined' ==
                            typeof TableTools.BUTTONS[a[d].sExtends]
                        ) {
                            alert(
                                'TableTools: Warning - unknown button type: ' +
                                    a[d].sExtends,
            ...
            _fnRowSelectConfig: function() {
                if (this.s.master) {
                    ...
                    'os' === this.s.select.type &&
                        (e(b.nTBody).on('mousedown.DTTT_Select', 'tr', function(
                            a,
                        ) {
                            if (a.shiftKey)
                                e(b.nTBody)
                    ...
                    b.oApi._fnCallbackReg(
                        ...
                        function(c, d, f) {
                            b.aoData[f]._DTTT_selected &&
                                e(c).addClass(a.classes.select.row)
                        },
                ...
                if (
                    ...
                    for (j = c.length; f < j; f++)
                        (c[f]._DTTT_selected = !0),
                            c[f].nTr &&
                                e(c[f].nTr).addClass(this.classes.select.row)
                ...
                if (
                    ...
                    for (j = c.length; f < j; f++)
                        (c[f]._DTTT_selected = !1),
                            c[f].nTr &&
                                e(c[f].nTr).removeClass(this.classes.select.row)
            ...
            _fnTextConfig: function(a, b) {
                ...
                e(a).hover(
                    ...
                    function() {
                        b.fnMouseout !== null &&
                            b.fnMouseout.call(this, a, b, null)
                    },
                )
                null !== b.fnSelect &&
                ...
                e(a).click(function(d) {
                    ...
                    b.fnComplete !== null &&
                        b.fnComplete.call(c, a, b, null, null)
            ...
            _fnFlashConfig: function(a, b) {
                ...
                'flash_save' == b.sAction
                    ? (d.setAction('save'),
                      d.setCharSet(
                          'utf16le' == b.sCharSet ? 'UTF16LE' : 'UTF8',
                      ),
                      d.setBomInc(b.bBomInc),
                      d.setFileName(
                          b.sFileName.replace('*', this.fnGetTitle(b)),
                      ))
                    : 'flash_pdf' == b.sAction
                    ? (d.setAction('pdf'),
                      d.setFileName(
            ...
            _fnChunkData: function(a, b) {
                for (var c = [], d = a.length, f = 0; f < d; f += b)
                    f + b < d
                        ? c.push(a.substring(f, f + b))
                        : c.push(a.substring(f, d))
                return c
            },
        ...
        TableTools._fnEventDispatch = function(a, b, c, d) {
            for (
                var f = TableTools._aListeners, e = 0, g = f.length;
                e < g;
                e++
            )
                a.dom.table == f[e].that.dom.table &&
                    f[e].type == b &&
                    f[e].fn(c, d)
        }

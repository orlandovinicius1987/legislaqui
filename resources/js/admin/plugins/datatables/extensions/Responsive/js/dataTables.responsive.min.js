    ...
    var o = function(e, k) {
        ...
        h.prototype = {
            _constructor: function() {
                ...
                c.type &&
                    ...
                    a.on('draw.dtr', function() {
                        a.rows({ page: 'current' }).iterator('row', function(
                            b,
                            c,
                        ) {
                            var f = a.row(c)
            ...
            _detailsVis: function() {
                ...
                if (
                    0 === c.length ||
                    (1 === c.length && this.s.columns[c[0]].control)
                )
                    b = !1
                b
                    ? a
            ...
            _find: function(d) {
                for (
                    var a = this.c.breakpoints, c = 0, b = a.length;
                    c < b;
                    c++
                )
            ...
            details: {
                renderer: function(d, a) {
                    var c = d
                        ...
                        .join('')
                    return c
                        ? e('<ul data-dtr-index="' + a + '"/>').append(c)
                        : !1
                },
                target: 0,
                type: 'inline',
        ...
        m.register('responsive.recalc()', function() {
            return this.iterator('table', function(d) {
                d._responsive &&
                    (d._responsive._resizeAuto(), d._responsive._resize())
            })
        })
        h.version = '1.0.6'
